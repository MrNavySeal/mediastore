...
search.addEventListener('input',function() {
    request(base_url+"/Usuarios/search/"+search.value,"","get").then(function(objData){
        if(objData.status){
...
sort.addEventListener("change",function(){
    request(base_url+"/Usuarios/sort/"+sort.value,"","get").then(function(objData){
        if(objData.status){
            element.innerHTML = objData.data;
        }else{
            element.innerHTML = objData.data;
...
function addItem(){
    ...
    let url = base_url+"/Usuarios/getRoles";
...
function editItem(id){
    ...
    request(url,formData,"post").then(function(objData){
        ...
        modalItem.innerHTML = modal;
        let modalView = new bootstrap.Modal(document.querySelector("#modalElement"));
        url = base_url+"/Usuarios/getRoles";
